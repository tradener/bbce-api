...
module BbceApi
  class DeadlineValuePayload
    ...
    def self.openapi_types
      {
        :'deadline_type' => :'Object',
        :'deadline_begin' => :'Object',
        :'deadline_end' => :'Object',
        :'limit_type' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BbceApi::DeadlineValuePayload` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BbceApi::DeadlineValuePayload`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      deadline_type_validator = EnumAttributeValidator.new('Object', ['M', 'Y'])
    ...
    def deadline_type=(deadline_type)
      validator = EnumAttributeValidator.new('Object', ['M', 'Y'])
    ...
    def hash
      [deadline_type, deadline_begin, deadline_end, limit_type].hash
    end
