...
module BbceApi
  class TickerLink
    ...
    # Unique Conversion Factor data ?
    attr_accessor :unique_conversion_factor
    ...
    def self.attribute_map
      {
        ...
        :'unique_conversion_factor' => :'uniqueConversionFactor',
    ...
    def self.openapi_types
      {
        ...
        :'features' => :'Object',
        :'cash_flows' => :'Object',
        :'unique_conversion_factor' => :'Object',
        :'created_at' => :'Object',
        :'updated_at' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BbceApi::TickerLink` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BbceApi::TickerLink`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'unique_conversion_factor')
        self.unique_conversion_factor = attributes[:'unique_conversion_factor']
      end
    ...
    def list_invalid_properties
      ...
      if @unique_conversion_factor.nil?
        invalid_properties.push('invalid value for "unique_conversion_factor", unique_conversion_factor cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @unique_conversion_factor.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          unique_conversion_factor == o.unique_conversion_factor &&
    ...
    def hash
      [id, link, minimum_lot, minimum_increment, price_type, start_permanence, end_permanence, features, cash_flows, unique_conversion_factor, created_at, updated_at].hash
    end
