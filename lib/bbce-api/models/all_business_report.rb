...
module BbceApi
  class AllBusinessReport
    ...
    attr_accessor :origin_operation_type
    ...
    # Date that the contract was created.
    ...
    def self.attribute_map
      {
        ...
        :'link_id' => :'linkId',
        :'origin_operation_type' => :'originOperationType',
        :'quantity' => :'quantity',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BbceApi::AllBusinessReport` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BbceApi::AllBusinessReport`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'origin_operation_type')
        self.origin_operation_type = attributes[:'origin_operation_type']
      end
    ...
    def list_invalid_properties
      ...
      if @origin_operation_type.nil?
        invalid_properties.push('invalid value for "origin_operation_type", origin_operation_type cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @origin_operation_type.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          link_id == o.link_id &&
          origin_operation_type == o.origin_operation_type &&
          quantity == o.quantity &&
    ...
    def hash
      [id, product_id, link_id, origin_operation_type, quantity, unit_price, trading_unit, measurement_unit, tendency, created_at, status].hash
    end
